...
export const ITEMS = {
  ...
  revolver: { name: 'Револьвер', icon: '🔫', model: 'revolver',
    gun: { dmg: 30, ammo: 'pistol_ammo', mag: 8, rate: 0.3, reload: 1.8, spread: 0.012, range: 140 } },
  ...
  // --- размещаемое ---
  campfire: { name: 'Костёр', icon: '🔥', stack: 3, deploy: 'campfire' },
...
export const LOOT = {
  ...
  scientist: [
    [1, 'pistol_ammo', 4, 12], [0.6, 'scrap', 5, 15], [0.4, 'metal_frag', 20, 50],
